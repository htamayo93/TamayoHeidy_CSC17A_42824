...
//            cin>>change;
//            change=toupper(change);//Changes the letter choice to uppercase
//            
//            info2.setchange(change);
//            //If statement to change the number of tries if the user wishes to
//            if(info2.getchange=='C'){
...
//            }
        ...
        answer=playA(answer);
        info2.setanswer(answer);
        
        //If statement if the user decides to play again.
        if(info2.getanswer=='Y'){
            cout<<"You have chosen '"<<info2.getanswer<<"' as your answer therefore ";
            cout<<"the game will repeat."<<endl;}
        
        n=1;//Resets the increment of tries
        info.limit=0;
    }while(info2.getanswer=='Y');
