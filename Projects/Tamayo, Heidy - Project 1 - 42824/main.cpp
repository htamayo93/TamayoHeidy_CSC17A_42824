        ...
        case 89:
        {
            ...
            if (!(compran[0]==choice[0])&&compran[1]==choice[1]&&
                ...
                cout<<endl;}
                    ...
                    compran[2]==choice[2]&&!(compran[3]==choice[3])){
                cout<<"XX";
                if(compran[1]==choice[3] && compran[3]==choice[1]){
                    cout<<"00";}
                else if(compran[1]==choice[3] && !(compran[3]==choice[1])){
                    cout<<"0";}
                else if(!(compran[1]==choice[3]) && compran[3]==choice[1]){
                    cout<<"0";}
                cout<<endl;}
               ...
               cout<<"X";
                ...
                if((compran[0]==choice[1]||compran[0]==choice[2]||compran[0]==choice[3])&&
                   (compran[1]==choice[0]||compran[1]==choice[2]||compran[1]==choice[3])&&
                   (compran[2]==choice[0]||compran[2]==choice[1]||compran[2]==choice[3])&&
                   (compran[3]==choice[0]||compran[3]==choice[1]||compran[3]==choice[2])){
                    cout<<"0000";}
                else if(!(compran[0]==choice[1]||compran[0]==choice[2]||compran[0]==choice[3])&&
                        (compran[1]==choice[0]||compran[1]==choice[2]||compran[1]==choice[3])&&
                        (compran[2]==choice[0]||compran[2]==choice[1]||compran[2]==choice[3])&&
                        (compran[3]==choice[0]||compran[3]==choice[1]||compran[3]==choice[2])){
                    cout<<"000";}
...
{
   //Output of results
    cout<<"The computer choices were            "<<compran[0]<<" "<<compran[1]<<" ";
    cout<<compran[2]<<" "<<compran[3]<<endl;
    cout<<"Your final results were              "<<choice[0]<<" "<<choice[1]<<" ";
    cout<<choice[2]<<" "<<choice[3]<<endl;
}
//000000011111111112222222222333333333344444444445555555555666666666677777777778
//345678901234567890123456789012345678901234567890123456789012345678901234567890
...
//ON THE SECOND TRY TRYING TO GUESS THE NAMME WAS NOT ALLOWED TO BE ENTERED ALSO 
