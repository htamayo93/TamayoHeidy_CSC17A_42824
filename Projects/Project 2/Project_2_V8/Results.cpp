...
Results::Results()//Constructor setting the values of the variables to 0
{
    limit=0;
    n=0;
}

void Results::setlimit(int x)//Brings the value from main and sets it
{
    limit=x;
}

void Results::setn(int x)//Brings the value from main and sets it
{
    n=x;
}
...
void Results::hints(string comp[], string perp[])//Hints of the function that is comparing the colors
{
    bool match[4];
    int x=0;                        
    int o=0;
