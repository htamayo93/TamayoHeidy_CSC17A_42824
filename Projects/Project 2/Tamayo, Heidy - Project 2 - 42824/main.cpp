...
#include "changelimit.h"//Class that changes the limit if the number of turns has
                        //ended
#include "Validation.h"//Class that validates the entres from the user
using namespace std;
...
int main(int argc, char** argv) {
    ...
    Validation valid;//Validates the input of the user 
    bool correct=true;//Used to validate the input of the user
    ...
    do
    {
        ...
        if(info.limit<10){   
            ...
            //Tests the user input if they have inputted a valid response to the question
            while(correct)
            {
                //Try catch statement testing the character inputted
                try{
        ...
        while (n+1<=info.limit)
        {
            ...
            if(n==info.limit)
            {
                ...
                //Resets the variable in order to test again
                correct=true;
