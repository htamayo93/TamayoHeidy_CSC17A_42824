...
int main(int argc, char** argv) {
    ...
    do
    {
        ...
        while (n+1<=info.limit)
        {
            ...
            {
                cout<<endl<<endl;
                cout<<"You have lost the game however you can increment your play by 1 if"<<endl;
                cout<<"you would like to keep playing. Type Y for yes or any other"<<endl;
                cout<<"character to not take a extra turn."<<endl;
                cin>>answer;
