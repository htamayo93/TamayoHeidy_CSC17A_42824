 ...
 * Purpose: Mean Median and Mode Calculation on a randomly generated set
 */
...
int main(int argc, char** argv) {
    ...
    int *frequent=freqF(array,mod,size);//Creating frequency array
    int max=findMax(frequent,mod);//Find the max Frequency
    int nModes=numMode(frequent,mod,max);//Find the number of modes
    int *modes=mode(frequent,mod,max,nModes);//Find the modes
    ...
    //Display Median
    cout<<"The median is ";
    float medianofA=median(array,size);
    cout<<medianofA<<endl;
   
    //Displays the Mean
    cout<<"The mean of this set is ";
    float meanofA=mean(array,size);
    cout<<meanofA;
...
//     a->Array filled with 2 digit integers
////////////////////////////////////////////////////////////////////////////////
int *mode(int *frequent,int size,int max,int nModes){
    //Declare and allocate memory
